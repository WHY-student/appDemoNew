...
public class ourGDUAircraft extends BaseProduct {
    ...
    public BaseProduct.Model getModel() {
        BaseProduct.Model model = BaseProduct.Model.UNKNOWN_AIRCRAFT;
        switch (GlobalVariable.planType) {
            case S200:
            case S200BDS:
                model = BaseProduct.Model.S200;
                break;
            case S220:
            case S220BDS:
            case S220_SD:
            case S220_SD_BDS:
                model = BaseProduct.Model.S220;
                break;
            case S280:
            case S280BDS:
                model = BaseProduct.Model.S280;
                break;
            case S220Pro:
            case S220ProS:
            case S220ProH:
            ...
            case S220ProSBDS:
            case S220ProHBDS:
                model = BaseProduct.Model.S220_PRO;
                break;
            case MGP12:
            case S480:
                model = BaseProduct.Model.S400;
                break;
        }
        return model;
    }
